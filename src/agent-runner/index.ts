 ...
 * Runs on the host, receives config via stdin, outputs result to stdout
 *
 * Input protocol:
...
async function runQuery(
  ...
  // Discover additional directories at extra path (if configured)
...
async function main(): Promise<void> {
  ...
  // Credentials are passed directly via environment variables from the host.
