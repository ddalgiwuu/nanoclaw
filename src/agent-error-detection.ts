 ...
 * and error strings. Used by provider-fallback, task-scheduler, and
 * message handling code.
 *
 * Ported from EJClaw — adapted for NanoClaw's module structure.
 */
 ...
 * Auth errors are provider-specific — use classifyClaudeAuthError for those.
 */
