...
Implementation, commits, and pushes require explicit agreement from both you and Codex.
...
When you read a message from Codex, react to it so they know you've seen it:
...
- Deadlock with Codex that cannot be resolved
...
- Keep coordination with Codex public
